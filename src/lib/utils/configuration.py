...
__C.DATA.cifar_train_class = []
__C.DATA.cifar_val_class = []
__C.DATA.cifar_test_class = []

__C.DATA.input_w = 0
__C.DATA.input_h = 0

__C.DATA.mean = [0.5, 0.5, 0.5]
__C.DATA.std = [0.5, 0.5, 0.5]
...
__C.TRAIN.need_cls_loss = True
__C.TRAIN.need_lda_cls_loss = False
